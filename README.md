...
| Metric | Value |
|---|---|
| ✅ Problems solved | **25 / 452** |
| 📈 Completion | **5.5%** |
| 🗓️ Last updated | 2026-08-07 |

## 🧭 Latest solved

**[Reverse an Array Using Recursion](01_learn-the-basics/05_learn-basic-recursion/025_reverse-an-array-using-recursion/README.md)** — Step 1: Learn the Basics (`2026-08-07`)

## 🗂️ Topic-wise progress

| | Step | Topic | Solved | Progress |
|---|---|---|---|---|
| 🔄 | Step 1 | Learn the Basics | 25 / 31 | 81% |
